...
All benchmark and flagship tasks are deterministic. No LLM, API key, network request, or stochastic sampler participates in the \system{} run. Consequently we report exact conformance counts, not means or confidence intervals. A repeated run tests reproducibility of the implementation, not sampling variance.
